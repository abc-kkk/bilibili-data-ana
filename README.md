...
在弹出的文件选择窗口中，选择你刚刚解压的整个插件文件夹。

安装成功！你会在浏览器右上角看到插件的图标。

💡 如何使用

确保你已经在Chrome浏览器中登录了你的B站账号。

访问任意一个你想分析的B站UP主的个人空间（例如：https://space.bilibili.com/xxxxxxxx）。

点击浏览器右上角的插件图标，会弹出一个小窗口。

在弹窗中点击 “分析数据” 按钮。

等待分析完成（如果UP主视频多，可能需要几十秒），窗口会提示找到的视频数量。

点击 “下载CSV文件” 按钮，即可将包含所有数据的表格保存到本地。

🤝 贡献与反馈

欢迎提出宝贵的意见和建议！如果你发现了Bug，或者有新的功能想法，请在 Issues 页面提出。
